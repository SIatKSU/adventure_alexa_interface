...
public final class LambdaFunctionHandler extends SpeechletRequestStreamHandler {
	...
	static {
		...
		supportedApplicationIds.add("amzn1.ask.skill.6fc210bb-e154-4588-9f8f-d9904990894a");
	}

	public LambdaFunctionHandler() {
		super(new ACSpeechlet(new DirectiveServiceClient()), supportedApplicationIds);
	}
}